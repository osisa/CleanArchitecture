...
using Microsoft.VisualStudio.TestTools.UnitTesting; //using BlazorHero.CleanArchitecture.Application.Models.Identity;
    ...
    public class HostServicesTests
    {
        ...
        private static IWebHostBuilder CreateWebHostBuilder(string environment = "Development")
            => new WebHostBuilder()
                ...
                .UseStartup<TestStartup2>(); // Startup class of your web app project
